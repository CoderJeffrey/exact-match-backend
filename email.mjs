  ...
  const sendEmail = async (email, jobs) => {
    ...
    * {
    ...
    <table style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      <tbody>
        <tr>
          <td style="overflow-wrap:break-word;background-color: #FFFFFF; word-break:break-word;padding:10px 10px;font-family:arial,helvetica,sans-serif;" align="left">
              ...
              <div style="height: 100%;width: 100% !important;">
                ...
                <div style="box-sizing: border-box; height: 100%; padding: 0px;border-top: 0px solid transparent;border-left: 0px solid transparent;border-right: 0px solid transparent;border-bottom: 0px solid transparent;">
                  ...
                  <table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                    <tbody>
                      <tr>
                        <td style="overflow-wrap:break-word;word-break:break-word;padding:41px 55px 18px;background-color: #FFFFFF; font-family:'Cabin',sans-serif;" align="left">
                  ...
                  <table style="font-family:'Cabin',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
                    <tbody>
                      <tr>
                        <td style="overflow-wrap:break-word;word-break:break-word;background-color: #FFFFFF; padding:10px 10px 33px;font-family:'Cabin',sans-serif;" align="left">
